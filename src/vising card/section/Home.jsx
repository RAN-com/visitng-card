...
const HomeSection = () => {
  return (
    <div
      className="page-wrapper bg-blue-500 text-white p-6 rounded-lg shadow-lg w-96 h-96"
      id="home-section"
    >
      <div className="upper flex flex-col items-center">
        <div className="views-label flex items-center text-gray-200 text-sm">
          <i className="fas fa-eye mr-2"></i>
          <span>Views: </span>
          <b className="ml-1">2310</b>
        </div>
        <img
